...
// loader declares every entry point inside `ur::level_zero::v1`. For the common
// entry points those `ur::level_zero::v1` symbols would otherwise be undefined.
...
inline ur_result_t urPlatformGetInfo(::ur_platform_handle_t hPlatform,
                                     ur_platform_info_t propName,
                                     size_t propSize, void *pPropValue,
                                     size_t *pPropSizeRet) {
  return ::ur::level_zero::urPlatformGetInfo(hPlatform, propName, propSize,
...
inline ur_result_t
urUsmP2PEnablePeerAccessExp(::ur_device_handle_t commandDevice,
                            ::ur_device_handle_t peerDevice) {
  return ::ur::level_zero::urUsmP2PEnablePeerAccessExp(commandDevice,
                                                       peerDevice);
}
inline ur_result_t
urUsmP2PDisablePeerAccessExp(::ur_device_handle_t commandDevice,
                             ::ur_device_handle_t peerDevice) {
  return ::ur::level_zero::urUsmP2PDisablePeerAccessExp(commandDevice,
                                                        peerDevice);
}
...
inline ur_result_t
urUsmP2PPeerAccessGetInfoExp(::ur_device_handle_t commandDevice,
                             ::ur_device_handle_t peerDevice,
                             ur_exp_peer_info_t propName, size_t propSize,
                             void *pPropValue, size_t *pPropSizeRet) {
  return ::ur::level_zero::urUsmP2PPeerAccessGetInfoExp(
